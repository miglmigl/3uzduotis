...
void isvedimas(std::vector<Studentas>& grupe, std::string gen, std::string ats, std::string rus_index) {
    if (gen == "T")
    {
        ...
        if (ats == "M") {
            ...
            std::cout << "--------------------------------------------------------------------------------------------------------------\n";
            for (auto& a : grupe) {
                std::cout << left << setw(20) << a.getPav() << setw(20) << a.getVar() << setw(20) << fixed << setprecision(2) << a.getMed() << setw(80) << &a << endl;
            }
        }
        else if (ats == "V") {
            ...
            for (auto& a : grupe) {
                std::cout << left << setw(20) << a.getPav() << setw(20) << a.getVar() << setw(20) << fixed << setprecision(2) << a.getGalutinis() << setw(80) << &a << endl;
            }
        }
    }
    else if (gen == "F") {
